...
func (p *orderDatabase) GetCoupon(c context.Context) ([]domain.Coupon, error) {
...
func (p *orderDatabase) GetCouponByCode(c context.Context, code string) (domain.Coupon, error) {
...
func (p *orderDatabase) AddCoupon(c context.Context, body domain.Coupon) error {
...
func (p *orderDatabase) EditCoupon(c context.Context, body request.EditCoupon) error {
